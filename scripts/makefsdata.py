...
dir_path = os.path.dirname(sys.argv[0]) + "./../src/"
print(dir_path)
dir_http_name = sys.argv[1]
...
if __name__ == '__main__':
    fsdata_c = open(dir_path + 'fsdata.c', 'w')
    fsdata_c.write('#include "fsdata.h"\n\n')
    fsdata_c.write('#include <stddef.h>\n\n')

    fsdata_h = open(dir_path + '/fsdata.h', 'w')

    os.chdir(dir_path + dir_http_name)
